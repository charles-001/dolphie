    ...
    def update(self, query_data: List[Dict[str, Any]]):
        ...
        for row in query_data:
            ...
            new_data_to_display[digest] = Row(
                ...
                row["sum_timer_wait"] - self._raw_statements_summary_data[digest].sum_timer_wait,
                row["sum_lock_time"] - self._raw_statements_summary_data[digest].sum_lock_time,
                row["sum_cpu_time"] - self._raw_statements_summary_data[digest].sum_cpu_time,
