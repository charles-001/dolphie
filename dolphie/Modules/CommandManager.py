        ...
        self.command_keys = {
            ConnectionSource.mysql: {
                "Commands": {
                    ...
                    "T": {
                        "human_key": "T",
                        "description": "Toggle displaying threads that only have an active transaction",
                    },
                    ...
                    "f": {"human_key": "f", "description": "Filter processlist by a supported option"},
                    "E": {"human_key": "E", "description": "Export the processlist to a CSV file"},
                    "k": {"human_key": "k", "description": "Kill a thread by its ID"},
                    "K": {"human_key": "K", "description": "Kill a thread by a supported option"},
                    "P": {
                        "human_key": "P",
            ...
            ConnectionSource.proxysql: {
                "Commands": {
                    ...
                    "e": {
                        "human_key": "e",
                        "description": "Display errors reported by BE servers during query execution",
                    },
                    "m": {"human_key": "m", "description": "Display memory usage"},
                    "t": {"human_key": "t", "description": "Display details of a thread"},
                    "u": {"human_key": "u", "description": "Display FE users connected"},
                    "v": {"human_key": "v", "description": "Display variables from SHOW GLOBAL VARIABLES"},
                    "z": {"human_key": "z", "description": "Display all entries in the host cache"},
                    "placeholder_4": {"human_key": "", "description": ""},
                    "c": {"human_key": "c", "description": "Clear all filters set"},
